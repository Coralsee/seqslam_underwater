    ...
    def preprocessing(params):
        ...
        for i in (params.dataset.imageIndices):
            ...
            img = Image.open(filename)
             ...
             # resize the image
            if params.DO_RESIZE:
                print "downsample to",params.downsample.size,"using method",params.downsample.method
                img = img.resize((params.downsample.size[0],params.downsample.size[1]), params.downsample.method)
            
            # convert to grayscale
            if params.DO_GRAYLEVEL:
                print "Doing graylevel shit"
            ...
            if len(params.dataset.crop) > 0:
                print "cropping the crap out of it"
            ...
            if params.DO_PATCHNORMALIZATION:
                print "Patch normalization crap"
